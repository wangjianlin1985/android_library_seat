...
<table width='100%' cellspacing='1' cellpadding='3'  class="tablewidth">
  <tr>
    <td width=30%>班级编号:</td>
    <td width=70%><%=classInfo.getClassNo() %></td>
  </tr>
  ...
  <tr>
    ...
    <td width=70%><%=bornDateSDF.format(classInfo.getBornDate()) %></td>
  </tr>

  <tr>
    <td width=30%>班主任:</td>
    <td width=70%><%=classInfo.getMainTeacher() %></td>
  </tr>
