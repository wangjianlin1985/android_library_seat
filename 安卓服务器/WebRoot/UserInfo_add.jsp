...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    ...
    <td width=70%>
      ...
      %>
          <option value='<%=userType.getUserTypeId() %>'><%=userType.getUserTypeName() %></option>
      <%
        }
      %>
    </td>
  ...
  <tr>
    ...
    <td width=70%><input id="userInfo.blackFlag" name="userInfo.blackFlag" type="text" size="20" /></td>
  </tr>

  <tr>
    <td width=30%>信用分:</td>
    <td width=70%><input id="userInfo.creditScore" name="userInfo.creditScore" type="text" size="8" /></td>
  </tr>
