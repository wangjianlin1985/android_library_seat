...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_userTypeObj = (TextView)convertView.findViewById(R.id.tv_userTypeObj);
	  ...
	  holder.tv_blackFlag = (TextView)convertView.findViewById(R.id.tv_blackFlag);
	  holder.tv_creditScore = (TextView)convertView.findViewById(R.id.tv_creditScore);
	  holder.tv_regTime = (TextView)convertView.findViewById(R.id.tv_regTime);
	  /*设置各个控件的展示内容*/
	  holder.tv_user_name.setText("用户名：" + mData.get(position).get("user_name").toString());
	  holder.tv_userTypeObj.setText("用户类型：" + (new UserTypeService()).GetUserType(Integer.parseInt(mData.get(position).get("userTypeObj").toString())).getUserTypeName());
	  ...
	  holder.tv_blackFlag.setText("是否黑名单：" + mData.get(position).get("blackFlag").toString());
	  holder.tv_creditScore.setText("信用分：" + mData.get(position).get("creditScore").toString());
	  holder.tv_regTime.setText("注册时间：" + mData.get(position).get("regTime").toString());
	  /*返回修改好的view*/
	  return convertView; 
    } 
    ...
    static class ViewHolder{ 
    	...
    	TextView tv_userTypeObj;
    	TextView tv_classObj;
    	TextView tv_name;
    	TextView tv_gender;
    	TextView tv_birthDate;
    	ImageView iv_userPhoto;
    	TextView tv_blackFlag;
