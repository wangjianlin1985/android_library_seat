	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if (room != null) { 
            ...
            if ("roomId".equals(tempString)) 
            	...
            	room.setRoomPhoto(valueString); 
            else if ("roomPlace".equals(tempString)) 
            	room.setRoomPlace(valueString); 
            else if ("seatNum".equals(tempString)) 
            	room.setSeatNum(new Integer(valueString).intValue());
        } 
	}
