...
public class UserInfoListHandler extends DefaultHandler {
	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if (userInfo != null) { 
            ...
            else if ("userTypeObj".equals(tempString)) 
            	userInfo.setUserTypeObj(new Integer(valueString).intValue());
            else if ("classObj".equals(tempString)) 
            	userInfo.setClassObj(valueString); 
            ...
            else if ("blackFlag".equals(tempString)) 
            	userInfo.setBlackFlag(valueString); 
            else if ("creditScore".equals(tempString)) 
            	userInfo.setCreditScore(new Float(valueString).floatValue());
