...
public class SelectSeatListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(SelectSeatListActivity.this, SelectSeatQueryActivity.class);
		...
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			...
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(SelectSeatListActivity.this, SelectSeatAddActivity.class);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new SelectSeatSimpleAdapter(SelectSeatListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(SelectSeatListActivity.this, SelectSeatDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑选座信息
			...
			Intent intent = new Intent();
			intent.setClass(SelectSeatListActivity.this, SelectSeatEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putInt("selectId", selectId);
			intent.putExtras(bundle);
	...
	protected void dialog() {
		Builder builder = new Builder(SelectSeatListActivity.this);
