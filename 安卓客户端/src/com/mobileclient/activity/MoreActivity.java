...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"阅览室","座位","座位状态","座位预约","选座","举报","奖惩","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
								if(arg2 == 0){
					Intent intent  = new Intent(MoreActivity.this, RoomListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, SeatListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
					Intent intent  = new Intent(MoreActivity.this, SeatStateListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 3){
					Intent intent  = new Intent(MoreActivity.this, SeatOrderListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 4){
					Intent intent  = new Intent(MoreActivity.this, SelectSeatListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 5){
					Intent intent  = new Intent(MoreActivity.this, JubaoListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 6){
					Intent intent  = new Intent(MoreActivity.this, JcListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 7){
