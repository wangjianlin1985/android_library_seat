...
public class UserInfoDetailActivity extends Activity {
	...
	// 声明用户类型控件
	private TextView TV_userTypeObj;
	// 声明所在班级控件
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		TV_userTypeObj = (TextView) findViewById(R.id.TV_userTypeObj);
		...
		TV_blackFlag = (TextView) findViewById(R.id.TV_blackFlag);
	...
	private void initViewData() {
		...
		UserType userTypeObj = userTypeService.GetUserType(userInfo.getUserTypeObj());
		this.TV_userTypeObj.setText(userTypeObj.getUserTypeName());
		...
		this.TV_blackFlag.setText(userInfo.getBlackFlag());
		this.TV_creditScore.setText(userInfo.getCreditScore() + "");
