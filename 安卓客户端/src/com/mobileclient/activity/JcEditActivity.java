			...
			public void onClick(View v) {
				try {
					...
					if(ET_jcType.getText().toString().equals("")) {
						Toast.makeText(JcEditActivity.this, "奖惩类型输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_title.getText().toString().equals("")) {
						Toast.makeText(JcEditActivity.this, "奖惩标题输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_content.getText().toString().equals("")) {
						Toast.makeText(JcEditActivity.this, "奖惩内容输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_creditScore.getText().toString().equals("")) {
						Toast.makeText(JcEditActivity.this, "信用分数输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_jcTime.getText().toString().equals("")) {
						Toast.makeText(JcEditActivity.this, "奖惩时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传奖惩信息*/
					JcEditActivity.this.setTitle("正在更新奖惩信息，稍等...");
